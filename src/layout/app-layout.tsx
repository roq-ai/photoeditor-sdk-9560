...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['developer', 'designer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Client', path: '/clients', entity: 'client', service: AccessServiceEnum.PROJECT, icon: FiUsers },
    { name: 'Image', path: '/images', entity: 'image', service: AccessServiceEnum.PROJECT, icon: FiImage },
    { name: 'Project', path: '/projects', entity: 'project', service: AccessServiceEnum.PROJECT, icon: FiFolder },
